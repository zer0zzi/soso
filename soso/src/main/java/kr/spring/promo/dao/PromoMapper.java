...
public interface PromoMapper {
	...
	@Insert("INSERT INTO promo_board (promo_num,promo_fixed,studyNum,promo_title,promo_status,promo_content,promo_uploadfile,promo_filename,promo_ip,mem_num) "
			+ "VALUES (promo_board_seq.nextval,#{promo_fixed},#{studyNum},#{promo_title},#{promo_status},#{promo_content},#{promo_uploadfile},#{promo_filename},#{promo_ip},#{mem_num})")
