			...
			<ul class="sort-option">
				<li>
					...
					<select name="sort" class="sort-select">
						...
						<option value="promo-ing" <c:if test="${param.sort=='promo-ing'}">selected</c:if>>모집중</option>
					...
					</select><input class="list-btn" type="button" value="목록" onclick="location.href='promoList.do'">
					<script>
					$(function(){
						$('.sort-select').change(function(){
							location.href='promoList.do?keyword='+$('#keyword').val()+'&keyfield='+$('#keyfield').val()+'&sort='+$(this).val();
						});
					});
					</script>
				</li>
