...
<div class="community-page-main">
	...
	<div class="sub-menu-left">
		<ul>
			<li><a style="color:#969CE4" href='${pageContext.request.contextPath}/community/fullList.do'>전체게시판</a></li>
	...
	<div class="full-sub-menu-right">
		...
		<ul>
			...
			<li>
				<input class="list-btn" type="button" value="목록" onclick="location.href='fullList.do'">
			</li>
		</ul>
		</form>
	</div>
