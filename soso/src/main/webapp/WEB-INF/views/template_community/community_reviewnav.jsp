...
<div class="community-page-main">
	...
	<div class="sub-menu-left">
		<ul>
			...
			<li><a style="color:#a5a6e9" href='${pageContext.request.contextPath}/community/reviewList.do'>후기</a></li>
			<c:if test="${!empty user && user.mem_auth<9}">
			<li>
				<input type="button" value="글작성" onclick="location.href='reviewWrite.do'" class="insert-btn">
			</li>
			</c:if>
			<c:if test="${!empty user && user.mem_auth==9}">
			<li>
				<input type="button" value="공지작성" onclick="location.href='reviewWrite.do'" class="insert-btn">
			</li>
			</c:if>
		</ul>
	</div>
				...
				<li>
					...
					$(function(){
						$('.sort-select').change(function(){
							location.href='reviewList.do?keyword='+$('#keyword').val()+'&keyfield='+$('#keyfield').val()+'&sort='+$(this).val();
						});
					});
					</script>
				</li>
